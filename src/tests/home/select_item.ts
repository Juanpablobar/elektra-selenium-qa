...
export const select_item_HOME = async () => {
  it("select_item", async () => {
    ...
    const shelfs: WebElement[] = await driver.findElements(By.css('.vtex-shelf-1-x-sliderContainer--home-product__recommend .vtex-shelf-1-x-slide--home-product__recommend'))
